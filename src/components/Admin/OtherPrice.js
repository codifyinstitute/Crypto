...
const OtherPrice = () => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        const response = await axios.get('https://crypto-anl6.onrender.com/static/get/66c445a358802d46d5d70dd4');
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await axios.put('https://crypto-anl6.onrender.com/static/put/66c445a358802d46d5d70dd4', formData);
